...
using SQ.CDT_SINAI.Shared.Validations;
...
namespace SQ.CDT_SINAI.Shared.DTOs
{
    ...
    public class RegisterCollaboratorDto
    {
        ...
        public int RoleId { get; set; } // Perfil de Acesso
        public List<int> EstablishmentIds { get; set; } = new(); // Estabelecimentos permitidos
    }
